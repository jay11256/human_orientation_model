...
results = model.predict("data_labeling/sampled_images", save=True, show_labels=False, show_conf=False, project="data_labeling", name="pose_images", stream=True, max_det = 5)
...
for r in results:
    ...
    r.save_txt(txt_file=f"data_labeling/pose_labels/{file_name}.txt")
