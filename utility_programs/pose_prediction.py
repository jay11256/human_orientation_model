...
results = model.predict("test_frames", save=True, show_labels=False, show_conf=False, project="pose_images", stream=True, max_det = 5)
...
for r in results:
    ...
    r.save_txt(txt_file=f"test_pose_labels/{file_name}.txt")
